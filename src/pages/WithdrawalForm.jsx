  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const body = {
        ...
        load_amount: form?.amount,
      };
      const response = await axiosWithHeaders.post(apis.WITHDRAWALS, body);
    ...
    <section className="overflow-hidden banner-section index-one">
      ...
      <div className="bg-transparent text-light min-vh-100 d-flex flex-column">
        ...
        <div className="flex-grow-1 d-flex justify-content-center align-items-center p-4">
          <div className="bg-dark text-white rounded-4 shadow-lg p-5 position-relative" style={{ maxWidth: 600, width: "100%" }}>
            <h2 className="fs-3 mb-4">Request Withdrawal</h2>

            {/* Instructions */}
            <ul className="text-light-50 small mb-4">
              <li className="mb-2">✓ Please fill out the form below to withdraw from brand.</li>
